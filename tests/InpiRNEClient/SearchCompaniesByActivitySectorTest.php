...
class SearchCompaniesByActivitySectorTest extends TestCase
{
    ...
    public function testSearchCompaniesByActivitySector(): void
    {
        ...
        $mock->shouldReceive('searchCompaniesByActivitySector')
            ->once()
            ->with('AGENT_COMMERCIAL') // should be an activity sector
            ->andReturn($mockedResponse);

        // Testez le comportement de recherche
        $result = $mock->searchCompaniesByActivitySector('AGENT_COMMERCIAL');
